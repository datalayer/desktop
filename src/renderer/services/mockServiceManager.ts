 ...
 * Provides service interfaces for read-only or demonstration modes.
 *
 * @module renderer/services/mockServiceManager
 */
...
export function createMockServiceManager(): ServiceManager.IManager {
  const mockServiceManager = {
    ...
    kernels: {
      ...
      startNew: async () => {
        throw new Error(
          'To enable running cells, you must select a kernel. Click "Start Kernel" to connect a runtime.'
        );
      },
      findById: () => undefined,
      connectTo: () => {
