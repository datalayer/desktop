...
var __electron_vite_injected_dirname = "/Users/goanpeca/Desktop/develop/datalayer/desktop";
var electron_vite_config_default = defineConfig({
  main: {
      ...
      }),
      {
        ...
        closeBundle() {
          try {
            ...
            copyFileSync(
              resolve(__electron_vite_injected_dirname, "src/main/dialogs/about/about.html"),
              resolve(__electron_vite_injected_dirname, "dist/main/about.html")
            );
            copyFileSync(
              resolve(__electron_vite_injected_dirname, "src/main/dialogs/about/about.css"),
              resolve(__electron_vite_injected_dirname, "dist/main/about.css")
            );
            copyFileSync(
              resolve(__electron_vite_injected_dirname, "src/main/dialogs/about/about.js"),
              resolve(__electron_vite_injected_dirname, "dist/main/about.js")
            );
            mkdirSync(resolve(__electron_vite_injected_dirname, "dist/resources"), { recursive: true });
            if (existsSync(resolve(__electron_vite_injected_dirname, "resources/icon.png"))) {
              copyFileSync(
                resolve(__electron_vite_injected_dirname, "resources/icon.png"),
                resolve(__electron_vite_injected_dirname, "dist/resources/icon.png")
              );
            }
          } catch (err) {
    ...
    resolve: {
      alias: {
        "@datalayer/core": resolve(__electron_vite_injected_dirname, "../core")
      },
      ...
      rollupOptions: {
        ...
        plugins: [
          commonjs({
            ...
            exclude: ["node_modules/@jupyter-widgets/base/**"],
    ...
    plugins: [
      {
        ...
        transform(code, id) {
          if (id.includes("@jupyter-widgets/base")) {
            ...
            if (fixed !== code) {
              console.log("[Vite Plugin] Fixed Backbone import in", id);
              return fixed;
            }
          }
          return null;
      ...
      {
        name: "inject-backbone-early",
        enforce: "post",
        transform(code, id) {
          if (code.includes("Backbone.View") || code.includes("extends Backbone")) {
            const backbonePolyfill = `
// CRITICAL: Ensure Backbone is available before class extends
if (typeof Backbone === 'undefined') {
  var Backbone = globalThis.Backbone || window.Backbone || {};
  if (!Backbone.View) {
    Backbone.View = class View {
      constructor(options) {
        this.cid = 'view' + Math.random();
        this._ensureElement();
...
`;
              const modifiedCode = code.slice(0, insertIndex) + symbolPolyfill + code.slice(insertIndex);
              return {
                code: modifiedCode,
                map: null
              };
